...
public class ParearPacientesCOVIDComEvolucaoCasoUti {
	...
	public static void main(String[] args) throws Exception {
		registrosSivep = SivepRedomeModificadoCSVHandler.carregarCSV("./arquivos/csv/uti/SIVEP_REDOME(Modificado-UTI).csv");
		registrosSus = SusRedomeModificadoCSVHandler.carregarCSV("./arquivos/csv/Sus_REDOME(AposUsoObito).csv");
		registrosSusAtualizado = new ArrayList<>(registrosSus);
		
		parearPacientesEntreSivepESus(26, 
				                      42, 
        ...
        SusRedomeModificadoCSVHandler.criarCSV("./arquivos/csv/Sus_REDOME(AposUsoUTI).csv", registrosSusAtualizado);
	...
	private static List<SusRedomeModificadoCSV> obterRegistrosUsadosComResultadoNegativo(List<SusRedomeModificadoCSV> registrosSusFiltradosRegistroSivep, int qtd) throws CsvDataTypeMismatchException, CsvRequiredFieldEmptyException, IOException {
		...
		registrosSusFiltradosComResultadoNegativo.stream().limit(qtd).forEach(r -> r.setObservacaoUso("Registro usado por Uti"));
	...
	private static List<SusRedomeModificadoCSV> obterRegistrosUsadosComResultadoPositivo(List<SusRedomeModificadoCSV> registrosSusFiltradosRegistroSivep, int qtd) throws CsvDataTypeMismatchException, CsvRequiredFieldEmptyException, IOException {
		...
		registrosSusFiltradosComResultadoPositivo.stream().limit(qtd).forEach(r -> r.setObservacaoUso("Registro usado por Uti"));
