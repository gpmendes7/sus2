...
public class ParearPacientesCOVIDComEvolucaoCasoRecuperado {
	...
	public static void main(String[] args) throws Exception {
		registrosSivep = SivepRedomeModificadoCSVHandler.carregarCSV("./arquivos/csv/recuperado/SIVEP_REDOME(Modificado-RECUPERADO).csv");
		registrosSus = SusRedomeModificadoCSVHandler.carregarCSV("./arquivos/csv/Sus_REDOME(AposUsoInternado).csv");
		registrosSusAtualizado = new ArrayList<>(registrosSus);
		
		parearPacientesEntreSivepESus(22, 
				                      42, 
		...
		parearPacientesEntreSivepESus(43,
					                  53, 
		...
		parearPacientesEntreSivepESus(54,
					                  74, 
        ...
        SusRedomeModificadoCSVHandler.criarCSV("./arquivos/csv/Sus_REDOME(AposUsoRecuperado).csv", registrosSusAtualizado);
	...
	private static List<SusRedomeModificadoCSV> obterRegistrosUsadosComResultadoNegativo(List<SusRedomeModificadoCSV> registrosSusFiltradosRegistroSivep, int qtd) throws CsvDataTypeMismatchException, CsvRequiredFieldEmptyException, IOException {
		...
		registrosSusFiltradosComResultadoNegativo.stream().limit(qtd).forEach(r -> r.setObservacaoUso("Registro usado por Recuperado"));
	...
	private static List<SusRedomeModificadoCSV> obterRegistrosUsadosComResultadoPositivo(List<SusRedomeModificadoCSV> registrosSusFiltradosRegistroSivep, int qtd) throws CsvDataTypeMismatchException, CsvRequiredFieldEmptyException, IOException {
		...
		registrosSusFiltradosComResultadoPositivo.stream().limit(qtd).forEach(r -> r.setObservacaoUso("Registro usado por Recuperado"));
